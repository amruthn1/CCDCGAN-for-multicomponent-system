...
def combine_two_database(
    database1_path="./a.npy", database2_path="./b.npy", new_database_path="./c.npy"
):
...
def generate_train_X(
    encodedsavepath="/home/teng/tensorflow2.0_example/ccGAN/original_crystal_2d_graphs_new/",
    X_train_savepath="./",
    ...
    for i in range(len(filename)):
        ...
        if eachnpyfile.endswith(".npy"):
            ...
            crystal_2d_graph_new = np.zeros(56 * 56)
            for i in range(
                len(
                    set(
                        read(
            ...
            crystal_2d_graph_new = crystal_2d_graph_new.reshape(1, 56, 56)
            if type(train_X) == int:
...
def generate_pre_train_X(
    crystal_folder_path="pre_crystal_for_check/",
    encodedsavepath="pre_2d_graph_for_check/",
    X_train_savepath="./",
    X_train_name="distance_train_X.npy",
):
...
def generate_train_y(
    constrainsavepath="/home/teng/tensorflow2.0_example/ccGAN/formation_energy_constrain/",
    y_train_savepath="./",
...
def generate_X_of_train_y2(
    constrainsavepath="/home/teng/tensorflow2.0_example/data_for_distance/GAN_batch64_epoch70000_generated_crystal/",
    Xsavepath="/home/teng/tensorflow2.0_example/data_for_distance/GAN_batch64_epoch70000_generated_2d_graphs/",
):
