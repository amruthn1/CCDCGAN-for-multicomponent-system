...
class constrain:
    def __init__(self):
        ...
        self.constrain.compile(
            loss="mean_squared_error", optimizer=optimizer, metrics=[r2_score]
        )
    ...
    def train(
        ...
        X_npy="./train_X.npy",
        y_npy="./train_y.npy",
        model_path="./model/formation_energy_reg.h5",
        epochs=50,
        batch_size=128,
        save_interval=50,
        split_ratio=0.9,
        ...
        for epoch in range(epochs):
            ...
            # Plot the progress
            print(
                "%d [test mse: %f, acc.: %.2f%%] [train mse: %f, acc.: %.2f%%]"
                % (epoch, d_loss[0], 100 * d_loss[1], d_loss_train[0], 100 * d_loss[1])
            )
