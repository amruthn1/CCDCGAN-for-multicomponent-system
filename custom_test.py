        ...
        if filename.endswith(".cif"):
            ...
            try:
                ...
                formation_energy_result = subprocess.check_output(
                    f"python ./alignn/alignn/pretrained.py --model_name jv_formation_energy_peratom_alignn --file_format cif --file_path {file_path}",
                    shell=True
                )
                ...
                energy_above_hull_result = subprocess.check_output(
                    f"python ./alignn/alignn/pretrained.py --model_name jv_ehull_alignn --file_format cif --file_path {file_path}",
                    shell=True
                )
                ...
                band_gap_result = subprocess.check_output(
                    f"python ./alignn/alignn/pretrained.py --model_name jv_mbj_bandgap_alignn --file_format cif --file_path {file_path}",
                    shell=True
                )
...
if __name__ == "__main__":
    ...
    cif_directory = "./save/generated_crystal_for_check/"  # Replace with your actual directory
